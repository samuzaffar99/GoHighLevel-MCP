    ...
    async handleToolCall(name, args) {
        switch (name) {
            ...
            case 'create_invoice_template':
                return this.client.createInvoiceTemplate(args);
            ...
            case 'update_invoice_template':
                ...
                return this.client.updateInvoiceTemplate(updateTemplateId, updateTemplateData);
            ...
            case 'create_invoice_schedule':
                return this.client.createInvoiceSchedule(args);
            ...
            case 'create_invoice':
                return this.client.createInvoice(args);
            case 'list_invoices':
            ...
            case 'send_invoice':
                ...
                return this.client.sendInvoice(sendInvoiceId, sendInvoiceData);
            // Estimate Handlers
            case 'create_estimate':
                return this.client.createEstimate(args);
            case 'list_estimates':
                return this.client.listEstimates(args);
            case 'send_estimate':
                const { estimateId: sendEstimateId, ...sendEstimateData } = args;
                return this.client.sendEstimate(sendEstimateId, sendEstimateData);
            case 'create_invoice_from_estimate':
                const { estimateId: invoiceFromEstimateId, ...invoiceFromEstimateData } = args;
                return this.client.createInvoiceFromEstimate(invoiceFromEstimateId, invoiceFromEstimateData);
            // Utility Handlers
...
exports.InvoicesTools = InvoicesTools;
