...
exports.SocialMediaTools = void 0;
class SocialMediaTools {
    ...
    async bulkDeleteSocialPosts(params) {
    ...
    async deleteSocialAccount(params) {
        const response = await this.ghlClient.deleteSocialAccount(params.accountId, params.companyId, params.userId);
        return {
            success: true,
            message: `Social media account ${params.accountId} deleted successfully`
        };
    }
    async getSocialCategories(params) {
        const response = await this.ghlClient.getSocialCategories(params.searchText, params.limit, params.skip);
        return {
            success: true,
    ...
    async getSocialCategory(params) {
    ...
    async getSocialTags(params) {
        const response = await this.ghlClient.getSocialTags(params.searchText, params.limit, params.skip);
        return {
            success: true,
    ...
    async getSocialTagsByIds(params) {
    ...
    async startSocialOAuth(params) {
        const response = await this.ghlClient.startSocialOAuth(params.platform, params.userId, params.page, params.reconnect);
        return {
            success: true,
    ...
    async getPlatformAccounts(params) {
        let response;
...
exports.SocialMediaTools = SocialMediaTools;
