...
Use this zone ID to create shipping rates or update zone configuration.`
    ...
    async updateShippingZone(params) {
        try {
            ...
            if (params.countries)
                request.countries = params.countries;
...
The shipping zone configuration has been updated successfully.`
     ...
     */
    async deleteShippingZone(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location'
...
⚠️ **Note:** Any existing orders using this shipping zone may be affected. Please ensure you have alternative shipping options configured.`
     ...
     */
    async getAvailableShippingRates(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location',
...
Select the appropriate shipping rate for checkout.`
     ...
     */
    async createShippingRate(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location',
...
The shipping rate is now active and available for orders.`
     ...
     */
    async listShippingRates(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location',
...
Use rate IDs to update or delete specific shipping rates.`
    ...
    async getShippingRate(params) {
        try {
            ...
            const response = await this.apiClient.getShippingRate(params.shippingZoneId, params.shippingRateId, request);
            const rate = response.data?.data;
            if (!rate) {
...
Use this rate information to manage shipping configurations.`
     ...
     */
    async updateShippingRate(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location'
            ...
            if (params.conditionType !== undefined)
                request.conditionType = params.conditionType;
            if (params.minCondition !== undefined)
                request.minCondition = params.minCondition;
            if (params.maxCondition !== undefined)
                request.maxCondition = params.maxCondition;
            if (params.isCarrierRate !== undefined)
                request.isCarrierRate = params.isCarrierRate;
            if (params.shippingCarrierId !== undefined)
                request.shippingCarrierId = params.shippingCarrierId;
            if (params.percentageOfRateFee !== undefined)
                request.percentageOfRateFee = params.percentageOfRateFee;
            if (params.shippingCarrierServices !== undefined)
                request.shippingCarrierServices = params.shippingCarrierServices;
            const response = await this.apiClient.updateShippingRate(params.shippingZoneId, params.shippingRateId, request);
            const rate = response.data?.data;
            if (!rate) {
...
The shipping rate configuration has been updated successfully.`
     ...
     */
    async deleteShippingRate(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location'
            };
            const response = await this.apiClient.deleteShippingRate(params.shippingZoneId, params.shippingRateId, request);
            return {
                content: [{
                        type: 'text',
...
⚠️ **Note:** This shipping option will no longer be available for new orders.`
     ...
     */
    async createShippingCarrier(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location',
...
Use this carrier to create dynamic shipping rates based on real-time carrier pricing.`
     ...
     */
    async updateShippingCarrier(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location'
            ...
            if (params.services !== undefined)
                request.services = params.services;
            if (params.allowsMultipleServiceSelection !== undefined)
                request.allowsMultipleServiceSelection = params.allowsMultipleServiceSelection;
...
The shipping carrier configuration has been updated successfully.`
     ...
     */
    async deleteShippingCarrier(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location'
...
⚠️ **Important:** Any shipping rates using this carrier will no longer function properly. Please update or remove associated shipping rates.`
     ...
     */
    async createStoreSetting(params) {
        try {
            const request = {
                altId: params.locationId || this.apiClient.getConfig().locationId,
                altType: 'location',
...
These settings control your store's shipping origin and email notification preferences.`
     ...
     */
    async executeStoreTool(toolName, params) {
        switch (toolName) {
            // Shipping Zones
