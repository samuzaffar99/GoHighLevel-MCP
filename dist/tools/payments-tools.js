    ...
    async handleToolCall(name, args) {
        switch (name) {
            ...
            case 'create_whitelabel_integration_provider':
                return this.client.createWhiteLabelIntegrationProvider(args);
            ...
            case 'create_order_fulfillment':
                ...
                return this.client.createOrderFulfillment(orderId, fulfillmentData);
            ...
            case 'create_coupon':
                return this.client.createCoupon(args);
            case 'update_coupon':
                return this.client.updateCoupon(args);
            case 'delete_coupon':
                return this.client.deleteCoupon(args);
            case 'get_coupon':
            ...
            case 'create_custom_provider_integration':
                ...
                return this.client.createCustomProviderIntegration(createLocationId, createProviderData);
            ...
            case 'create_custom_provider_config':
                ...
                return this.client.createCustomProviderConfig(configLocationId, configData);
            case 'disconnect_custom_provider_config':
                const { locationId: disconnectLocationId, ...disconnectData } = args;
                return this.client.disconnectCustomProviderConfig(disconnectLocationId, disconnectData);
            default:
                throw new Error(`Unknown tool: ${name}`);
        }
    }
}
exports.PaymentsTools = PaymentsTools;
