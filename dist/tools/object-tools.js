...
class ObjectTools {
     ...
     */
    async createObjectSchema(params) {
        try {
            const schemaData = {
     ...
     */
    async updateObjectSchema(params) {
        try {
            const updateData = {
                labels: params.labels,
                description: params.description,
     ...
     */
    async createObjectRecord(params) {
        try {
            const recordData = {
     ...
     */
    async updateObjectRecord(params) {
        try {
            const updateData = {
                properties: params.properties,
                locationId: params.locationId || this.ghlClient.getConfig().locationId,
     ...
     */
    async deleteObjectRecord(params) {
        try {
     ...
     */
    async searchObjectRecords(params) {
        try {
            const searchData = {
                locationId: params.locationId || this.ghlClient.getConfig().locationId,
                page: params.page || 1,
